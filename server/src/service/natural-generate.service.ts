...
export class NaturalGenerateService {
  ...
  public generateNewNaturalRandomTileSelection(
  ...
  public generateNewNaturalColumnsTileSelection(
    mappings: ContentTileFillingData,
  ): string {
    const area = this.generateEmptyArea();
  ...
  private fillNaturalColumnsTileSelection(
    mappings: ContentTileFillingData,
    area: string[][],
  ): void {
  ...
  private fillNaturalRandomTileSelection(
    mappings: ContentTileFillingData,
    area: string[][],
  ): void {
  ...
  private getCandidateToFillAdjacentTile(
    sourceTile: string,
    mappings: ContentTileFillingData,
  ): string {
    let rc = '';
    const candidate = mappings.mapping.data.find(
      (mapping) => mapping.source === sourceTile,
    );
    if (!candidate) {
